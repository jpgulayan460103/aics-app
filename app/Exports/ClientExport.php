...
class ClientExport implements FromCollection, WithHeadings, WithMapping
{
    ...
    public function map($aics_client): array
    {
        return [
            ...
            $aics_client->psgc()->exist() ? $aics_client->psgc->region_name."/".$aics_client->psgc->region_psgc : "",
            $aics_client->psgc()->exist() ? $aics_client->psgc->province_name."/".$aics_client->psgc->province_psgc : "",
            $aics_client->psgc()->exist() ? $aics_client->psgc->city_name."/".$aics_client->psgc->city_psgc : "",
            $aics_client->psgc()->exist() ? $aics_client->psgc->brgy_name."/".$aics_client->psgc->brgy_psgc : "",
            $aics_client->psgc()->exist() ? $aics_client->psgc->district : "",
            ...
            $aics_client->age,
            "mode_of_admision",
            $aics_client->aics_type()->exist() ? $aics_client->aics_type->name : "",
            $aics_client->payroll()->exist() ?  $aics_client->amount: "",
            "",
            "",
            "",
            "",
